...
{
    public class DictionaryEnumerator<TKey, TValue, TState> : Enumerator
    ...
    public class ListEnumerator<TValue, TState> : Enumerator
        <IEnumerable<TValue>,
        TValue,
        TState>
        where TState : struct
    ...
    public class Enumerator<TEnumerable, TItem, TState>
